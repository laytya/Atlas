...
elseif GetLocale() == "esES" then
	...
	SHOW_COLORED_TEXT_DESC = "Permite que el plugin coloree su texto."
	DETACH_TOOLTIP = "Separar tooltip"
	DETACH_TOOLTIP_DESC = "Separa el tooltip del panel."
	LOCK_TOOLTIP = "Bloquear tooltip"
	LOCK_TOOLTIP_DESC = "Bloquea la posición del tooltip. Cuando el tooltip está bloqueado, debe usar Alt para accederlo con tu ratón."
	POSITION = "Posición"
	POSITION_DESC = "Coloca el plugin en el panel."
	POSITION_LEFT = "Izquierdo"
	POSITION_RIGHT = "Derecho"
	POSITION_CENTER = "Centro"
	ATTACH_TO_MINIMAP = "Adjuntar al minimapa"
	ATTACH_TO_MINIMAP_DESC = "Adjunta el plugin al minimapa en lugar del panel."
	HIDE_FUBAR_PLUGIN = "Ocultar plugin"
	HIDE_FUBAR_PLUGIN_CMD = "Hidden"
	HIDE_FUBAR_PLUGIN_DESC = "Oculta el plugin desde el panel o minimapa, dejando el plugin ejecutándose."
